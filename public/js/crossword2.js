...
class CrosswordGame{
    ...
    */
    ...
    play(serverBox,playButton) {
       ...
       this.getPuzzles(this.#playerID);
       this.getGamesRequest(this.#playerID);
     }
     ...
     watchAndLook(gameID, playerID) {
       ...
       req.addEventListener("load", function onWatchLoad() {
         ...
         setTimeout(() => {
           ...
           root.watchAndLook(gameID, playerID);
         }, 1);
       });
 ...
 //////////////////////////    HTML/JS UI ELEMENTS : MUTATORS     ///////////////////////
       ...
       if (puzzlesTable) {
         puzzleData.forEach((piece) => {
           ...
           puzzleButton.addEventListener("click", () => {
             ...
             this.createGameRequest(piece.id, gameID, playerID);
           });
     ...
     drawGames(playerID, gameData) {
       ...
       gameData.forEach((game) => {
         ...
         gameButton.addEventListener("click", () => {
           ...
           this.watchAndLook(game.gameID, playerID);
         ...
         showPlayers.addEventListener("click", () => {
           ...
           this.removeAllChildNodes(gamePlayers);
           this.getPlayersRequest(game.gameID, gamePlayers);
         });
     ...
     createGame(puzzleID, playerID) {
       ...
       gameButton.className = "puzzle-button";
       gameButton.addEventListener("click", () => {
         this.getPuzzleUIRequest(gameID, playerID, puzzleID);
         this.joinGameRequest(gameID, playerID);
         this.watchAndLook(gameID, playerID);
       ...
       showPlayers.addEventListener("click", () => {
         gamePlayers.classList.toggle("game-players-container-reveal");
         this.removeAllChildNodes(gamePlayers);
         this.getPlayersRequest(gameID, gamePlayers);
       });
      ...
      */
      ...
      renderGameData(gameID, playerID, puzzleData) {
       ...
       this.removeAllChildNodes(gridTableContainer);
       this.removeAllChildNodes(cluesContainer);
       ...
       this.renderClues(puzzleData.words);
     }
